...
class SearchResultVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(UITableViewCell.self, forCellReuseIdentifier: "UITableViewCellReuseIdentifier")
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = search_results[indexPath.row]
        // Configure the cell...
