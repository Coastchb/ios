...
class NAHomeViewController : UIViewController,WKNavigationDelegate,WKScriptMessageHandler,WKUIDelegate,UINavigationControllerDelegate, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let path = Bundle.main.path(forResource: "36kr", ofType: "html")
        ...
        // load remote html
        let url_string = "https://www.w3school.com.cn/html5/index.asp"
